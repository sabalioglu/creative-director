...
export const CAMERA_OPTIONS: SelectionOption[] = [
    ...
    { id: 'cam-gopro', label: 'GoPro Hero', image: '/assets/camera bodies/GOPRO HERO.png' },
    { id: 'cam-hasselblad', label: 'Hasselblad X1D II', image: '/assets/camera bodies/HASSELBLAD X1D II.png' },
    { id: 'cam-lomo', label: 'Lomo LC-A', image: '/assets/camera bodies/LOMO LC‑A.png' },
    { id: 'cam-panasonic', label: 'Panasonic VariCam', image: '/assets/camera bodies/PANASONIC VARICAM.png' },
